...
export default function Gallery(props){
    return (
        <div style={{ margin: `${props.isMobile ? 0 : 2}vh 0`, width: '100vw', padding: `10px 0`, justifySelf: 'center', background: props.background || 'url(https://images.pexels.com/photos/6044224/pexels-photo-6044224.jpeg?cs=srgb&dl=pexels-skylar-kang-6044224.jpg&fm=jpg&_gl=1*mviqoo*_ga*MTY4ODkyODE0MS4xNzAyMDM2Mzk4*_ga_8JE65Q40S6*MTcwNjg5NTk2MS4xMC4xLjE3MDY4OTU5NjQuMC4wLjA.)' }}>
